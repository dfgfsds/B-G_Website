                    ...
                    <div className="space-y-10">
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-700 leading-relaxed">
                                Welcome to <strong>B&amp;G</strong> — where quality, craftsmanship, and elegance come together to create products that
                                elevate your everyday living.
                                <br /><br />
                                Founded by <strong>TKS Babu</strong>, <strong>B&amp;G</strong> stands as a symbol of trust and excellence, offering a
                                curated range of products designed to blend style, durability, and functionality.
                                <br /><br />
                                At <strong>B&amp;G</strong>, we believe in thoughtful design and attention to detail. Each item reflects our commitment
                                to delivering exceptional quality that adds a touch of sophistication to your lifestyle.
                                <br /><br />
                                Discover the <strong>B&amp;G</strong> experience — where tradition meets innovation, and every creation tells a story
