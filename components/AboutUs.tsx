    ...
    <section className="py-12 px-4 md:px-12 lg:px-24 bg-white text-gray-800">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-lg leading-relaxed mb-6">
          At <strong>B&amp;G (Blush &amp; Glow)</strong>, we believe every woman deserves to feel
          beautiful, confident, and cared for — inside and out. Founded with a passion for empowering
          women through elegance and self-care, B&amp;G brings together a curated collection of ladies’
        ...
        <p className="text-lg leading-relaxed mb-6">
          ...
          <strong> B&amp;G</strong> is your one-stop shop for beauty, comfort, and confidence.
        </p>

        {/* Divider */}
        <div className="mt-10 mb-10 flex justify-center">
          <div className="w-32 h-1 bg-yellow-500 rounded"></div>
        </div>

        {/* Brand Section */}
        <h3 className="text-2xl font-semibold text-yellow-500 mb-4">✨ Our Brand</h3>

        <p className="text-lg leading-relaxed mb-6">
          <strong>B&amp;G (Blush &amp; Glow)</strong> stands for purity, elegance, and empowerment.
          We combine quality, affordability, and style to bring you thoughtfully selected products that
          celebrate womanhood in all its forms.
        </p>

        <ul className="list-disc pl-6 text-lg leading-relaxed mb-6 space-y-3">
          <li>
        ...
        <p className="text-lg leading-relaxed mb-10">
          ...
          <strong> B&amp;G</strong>, we don’t just sell products; we deliver trust, comfort, and beauty
          in every box.
        </p>
        ...
        {/* Promise Section */}
        <h3 className="text-2xl font-semibold text-yellow-500 mb-4">💎 Our Promise</h3>

        <ul className="pl-6 text-lg leading-relaxed space-y-3">
