        ...
        <div className="max-w-6xl mx-auto px-2 md:px-4 py-10" ref={topRef}>
            <div className="my-2 mb-5 flex">
                ...
                <div className="text-md text-gray-400 flex mt-0.5 gap-1">
                    <span>
                        Home</span><span className='cursor-pointer flex' onClick={() => router.back()}>/ {categoryName}</span>  <span className='text-yellow-500'>/ Shop</span></div>
            </div>
            {/* <img
            ...
            /> */}
            {/* <h1 className='m-2 font-bold text-2xl text-center text-yellow-500'>
                {categoryName}
            </h1>
            <div className='m-2'>
