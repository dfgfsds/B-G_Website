...
import { deleteCouponApi, getAddressApi, getAllCouponsApi, getAppliedCouponDataApi, getCartApi, postApplyCouponApi, postCODPaymentApi, postDtdcChargeApi, postPaymentApi, removeCartCoupon } from '@/api-endpoints/CartsApi';
    ...
    <>
      {data?.data?.length ? (
        <div className="space-y-3 mb-3">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="text-sm text-yellow-500 font-bold  hover:text-red-700"
        ...
        <div className="text-center p-4 bg-gray-50 rounded-lg mb-3">
          ...
          <p className="mt-2 inline-block text-sm text-yellow-500 hover:text-red-700 font-bold cursor-pointer"
            onClick={() => {
      ...
      <div className="bg-[#F8F7F2] rounded-xl p-3">
        ...
        <h2 className="text-xl mt-5 font-semibold mb-6">Order Summary</h2>
            ...
            <>
              <div className="space-y-4 font-bold !text-gray-600 mt-1">
                <div className="flex justify-between">
                  ...
                  <span>{(Number(DeliveryChargeValue?.final_delivery_charge))}</span>
                </div >
              </div >
              {getAppliedCouponData?.data?.data?.applied_coupons[0]?.discount ? (
                <div className="space-y-4 font-bold !text-gray-600 mt-1">
                  <div className="flex justify-between">
                    ...
                    <span>{convertPrice(Number(getAppliedCouponData?.data?.data?.applied_coupons[0]?.discount))}</span>
                  </div >
                </div >
              ...
              <div className="space-y-4 font-bold !text-gray-600 mt-1">
                <div className="flex justify-between">
                  ...
                  <span>{(Number(DeliveryChargeValue?.final_price_including_delivery))}</span>
                </div>
              </div>
            </>
        }
        ...
        <div className="mt-6 space-y-4">
          ...
          ${paymentValue === item?.value ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:bg-gray-50'}`}
              >
                <input
                  ...
                  className="mt-1 h-4 w-4 text-yellow-500 border-gray-300 focus:ring-red-700"
                />
                <div className="ml-3">
          ...
          {!data?.data?.length ? (
            <button className="w-full p-2 bg-yellow-500 cursor-pointer hover:bg-red-700 text-white font-bold"
              onClick={() => {
                router.push('/profile?tab=addresses')
              }}
            >
            ...
            <>
              <button className="w-full p-2 flex gap-2 justify-center bg-yellow-500 cursor-pointer hover:bg-red-700 text-white font-bold"
