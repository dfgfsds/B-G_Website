    ...
    return (
        <>
            <header className="w-full pb-4 bg-white">
                        ...
                        <div className="relative" ref={userMenuRef}>
                            {userName || userId ? (
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 cursor-pointer bg-yellow-500 text-white px-4 py-2 rounded-md"
                                >
                                    <User size={18} /> Login
                                </button>
                            )}
                ...
                {/* ---------- DESKTOP MAIN NAV --------------------------------------- */}
                <div className="hidden lg:flex justify-evenly px-12 py-1 text-md text-white bg-yellow-500 mx-10 rounded-md">
