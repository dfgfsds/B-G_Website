    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="bg-yellow-500 hover:bg-red-700 text-white font-bold px-4 py-2 rounded-md flex items-center gap-2"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {data?.data?.map((address: any) => (
            <div key={address.id} className="relative bg-white p-4 rounded-lg shadow-md">
              ...
              {/* Header */}
              <div className="mb-2">
                {address?.customer_name && !address?.customer_name === null && (
                  <h3 className="uppercase font-semibold">{address?.customer_name}</h3>
                )}
          ...
          >
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              <button
                ...
                disabled={loading}
                className="px-4 py-2 bg-yellow-500 text-white rounded-md text-sm font-bold hover:bg-red-700 flex items-center gap-2"
              >
