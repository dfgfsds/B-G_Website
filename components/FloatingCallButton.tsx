    ...
    return (
        <>
            ...
            <Link
                ...
                className={`fixed bottom-36 md:bottom-24 ${floatingCallData?.call?.alignment?.split('-')[1]}-5 z-50 flex items-center justify-center w-11 h-11 sm:w-13 sm:h-13 rounded-full bg-gradient-to-r from-red-700 to-red-600 text-white shadow-lg border border-red-600 transition-transform duration-300 hover:shadow-2xl`}
                aria-label="Call Us"
            >
