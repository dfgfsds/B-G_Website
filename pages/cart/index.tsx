        ...
        {cartItem?.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-max  text-gray-800 animate-fadeIn">
            <div className="text-6xl text-gray-400 animate-float">
              <ShoppingBag className="h-16 w-16 text-yellow-400 mb-4" />
            </div>
            ...
            <Link href="/shop">
              <button
                className="mt-8 px-6 py-3 font-bold bg-yellow-500 text-white rounded-full shadow-md hover:bg-yellow-300 transform transition hover:scale-105 animate-bounce"
              >
                Return To Shop
              </button>
            </Link>
