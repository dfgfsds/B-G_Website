          ...
          <div>
            {!showPasswordReset && (
              <form onSubmit={handleEmailSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full gap-2 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-500 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  disabled={emailLoader}
                >
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white w-full max-w-md p-6 rounded shadow-lg relative">
                  ...
                  <div className="text-center text-sm text-gray-500 mb-4 cursor-pointer">
                    {timer === 0 ? (
                      <>
                        <span className="cursor-pointer text-yellow-500 font-bold" onClick={sendOtpToEmail}>Resend</span>
                      </>
                    ) : (
                      <>
                  ...
                  <div className="flex justify-between">
                    <button
                      ...
                      className="w-full cursor-pointer  bg-yellow-500 text-white py-2 rounded hover:bg-yellow-500"
                      disabled={optLoader}
                    >
            ...
            {showPasswordReset && (
              <form onSubmit={handlePasswordReset} className="space-y-5 mt-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-yellow-500 text-white py-2 rounded-md hover:bg-yellow-500 disabled:cursor-not-allowed"
