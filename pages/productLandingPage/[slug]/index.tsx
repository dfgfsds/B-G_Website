                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-6 mb-3 space-y-2 text-sm text-gray-700 border-y py-2 border-gray-200">
                            <li><strong>Brand:</strong> <span className='uppercase'>{productDetails?.brand_name}</span></li>
                        ...
                        <div className="mt-6 flex gap-2">
                            <button
                                className="bg-yellow-500 text-white px-5 py-2 rounded hover:bg-yellow-300 flex items-center gap-2"
                        ...
                        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-300 p-4 md:hidden">
                            <div className="flex items-center justify-between gap-1 flex-wrap">
                                ...
                                {/* Buy Now Button */}
                                <button
                                    className="flex bg-yellow-500 text-white py-3 px-2 rounded-lg shadow-lg hover:bg-red-700 flex items-center justify-center gap-2"
                                    onClick={() => setMobileModal(true)}
                                >
                                    <ShoppingBasket size={18} /> Buy Now
                                </button>
                    ...
                    productDetails?.id == 19403 && (
                        <div className="bg-white text-gray-800 mt-10">
                            ...
                            <section className="py-12 px-6 text-center">
                                ...
                                <button onClick={() => setMobileModal(true)} className="bg-yellow-500 text-white px-6 py-3 rounded-lg hover:bg-yellow-500 transition">
                                    Grab Your Combo Now
                                </button>
                            </section>
                        </div>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 z-[60] flex items-center justify-center px-4">
                        <div className="bg-white w-full max-w-md p-6 rounded shadow-lg relative">
                            ...
                            <form onSubmit={handleMobileSubmit} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-yellow-500 text-white py-2 rounded hover:bg-red-700"
                        ...
                        {(!userExists || address?.data?.length === 0 || isAddingNewAddress) ? (
                            <>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full text-center bg-yellow-500 text-white py-2 rounded hover:bg-red-700"
                                    >
                            ...
                            <>
                                ...
                                <button className="w-full mt-10 p-2 flex gap-2 justify-center bg-yellow-500 cursor-pointer hover:bg-red-700 text-white font-bold" onClick={handleCheckout}>Proceed to Checkout</button>
